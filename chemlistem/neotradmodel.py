...
class NeoTradModel(object):
    ...
    def train(self, textfile, annotfile, glovefile, runname):
        ...
        self.unkl = ["*UNK*", "*UNKre_num*", "*UNKre_pc*", "*UNKyl*", "*UNKate*", "*UNKated*", "*UNKed*", "*UNKing*", "*UNKic*", "*UNKtion*", "*UNKal*", "*UNKive*", "*UNKly*", "*UNKane*", "*UNKene*", "*UNKyne*", "*UNKine*", "*UNKase*", "*UNKble*", "*UNKity*", "*UNKrgic*", "*UNKein*", "*UNKin*", "*UNKose*", "*UNKone*", "*UNKdehyde*", "*UNKol*", "*UNKide*", "*UNKite*", "*UNKium*", "*UNKs*"]
